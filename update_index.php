...
<!-- 
        Acest fisier reprezinta pagina corespunzatoare pagini cu Updateuri. Initial am niste cod de CSS pentru a aranja aspectul paginii. Apoi
        ...
        <div class="container_1">
            ...
            <div class = "div_3 container_2">
                ...
                <div class = "div_4 pl-3"> 
                    <br>
                    <!--
                        Partea aceasta de cod reprezinta partea in care dam update la datele din baza de date.
                    -->
                    <h3> Update din tabelul artisti </h3>
                    <form action="#" method="POST" class="form-inline">
                        ...
                        <div class="form-row p-2">  
                            <div class="col">
                                ...
                                <select class="form-control" name="Coloana">
                                    <option>Coloana</option>
                                    <option>Nume</option>
                                    <option>Prenume</option>
                                    <option>CNP</option>
                                    <option>Nationalitate</option>
                                    <option>Sex</option>
                                    <option>Data_Nastere</option>
                                </select>
                            </div>
                            <div class="col">
                                <input type="text" class="form-control p-3" placeholder="Valoare" name="value">
                            </div>
                        </div>
                        <br><br>     
                        <!-- Buton de submit pentru update -->
                        <input type="submit"  name="submit_update" value="Update" class="btn btn-pill btn-dark"/> 
                    </form>
                    ...
                    <?php
                        ...
                        if (isset($_POST['submit_update'])){
                            ...
                            $valoare = $_POST['value'];
                            //In variabila sql_1 pun codul specific query-ului  care face update pe tabelul artisti.
                            $sql_1 = " UPDATE artisti SET $coloana = '$valoare' WHERE Nume = '$nume' AND Prenume = '$prenume';";
                ...
                <br>
                <!--
                    Partea aceasta de cod reprezinta partea in care dam update la datele din baza de date, mai exact la tabelul obiecte de arta.
                    Pasii sunt acceasi ca cei de mai sus.
                -->
                <h3> Update din tabelul obiecte de arta </h3>
                    <form action="#" method="POST" class="form-inline">
                        <div class="form-row p-2">
                            <div class="col">
                                <input type="text" class="form-control p-3" placeholder="Denumire_obiect" name="denumire">
                            </div>
                            <div class="col">
                                <input type="text" class="form-control p-3" placeholder="Tip" name="tip_value">
                            </div>
                        </div>  
                        <div class="form-row p-2">  
                            <div class="col">
                                <select class="form-control" name="Coloana_2">
                                    <option>Coloana</option>
                                    <option>Denumire_obiect</option>
                                    <option>Tip</option>
                                    <option>Data_finisare</option>
                                    <option>Pret</option>
                                    <option>De_vanzare</option>
                                    <option>Descriere</option>
                                </select>
                            </div>
                            <div class="col">
                                <input type="text" class="form-control p-3" placeholder="Valoare" name="value_2">
                            </div>
                        </div>
                        <br><br>     
                        <input type="submit"  name="submit_update_2" value="Update" class="btn btn-pill btn-dark"/> 
                    </form>

                    <?php
                        if (isset($_POST['submit_update_2'])){

                            $den = $_POST['denumire'];
                            $tip = $_POST['tip_value'];
                            $coloana = $_POST['Coloana_2'];
                            $valoare = $_POST['value_2'];

                            $sql_2 = " UPDATE obiecte_de_arta SET $coloana = '$valoare' WHERE Denumire_obiect = '$den' AND Tip = '$tip';";
                            UPDATE obiecte_de_arta SET De_vanzare = 'Nu' WHERE Denumire_obiect = 'Fecioara cu Pruncul' AND Tip = 'icoana';
